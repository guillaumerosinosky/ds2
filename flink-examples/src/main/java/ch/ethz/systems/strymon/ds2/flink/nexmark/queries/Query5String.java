...
public class Query5String {

    private static final Logger logger  = LoggerFactory.getLogger(Query5String.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (alloy) {
            windowed = DataStreamUtils.reinterpretAsKeyedStream(bids, new KeySelector<Bid, String>() {
                @Override
                public String getKey(Bid bid) throws Exception {
                    return Long.toString(bid.auction);
                }
