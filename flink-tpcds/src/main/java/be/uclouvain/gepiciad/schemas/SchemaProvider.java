...
public class SchemaProvider {
    ...
    private static final Map<String, Schema> schemaMap = createTableSchemas();

    private static Map<String, Schema> createTableSchemas() {
        final Map<String, Schema> schemaMap = new HashMap<String, Schema>(tpc);
        schemaMap.put(
                "catalog_sales",
                new Schema(
                        Arrays.asList(
    ...
    public static Schema getTableSchema(String tableName) {
        Schema result = schemaMap.get(tableName);
        if (result != null) {
            return result;
        } else {
